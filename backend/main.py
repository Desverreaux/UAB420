...
async def lorem_ipsum(wordCount: int = 20):
    ...
    print(os.getenv("NINJAS_API_KEY")) # Log the API key for debugging (make sure to remove this in production!)
    print(f"API Response: {response.json()}") # Log the full API response for debugging
